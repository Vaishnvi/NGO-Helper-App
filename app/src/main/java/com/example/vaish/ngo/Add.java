...
public class Add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Add=(Button) findViewById(R.id.login);
        AddData();
    ...
    public void AddData()
    {
        Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Isinserted)
                    Toast.makeText(Add.this,"Data is inserted",Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Add.this,"Data is not inserted",Toast.LENGTH_SHORT).show();
