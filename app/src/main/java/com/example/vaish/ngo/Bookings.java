...
public class Bookings extends AppCompatActivity
    ...
    Spinner spinner;
    String places;
    Button findNGOs,book;
    EditText selectedngo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                findNGOs.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Bookings.this,NGOMapsActivity.class);
                        i.putExtra("message",places);
                        startActivity(i);
                    }
                });
            }
        ...
        book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Bookings.this,finalbooking.class);
                i.putExtra("message",selectedngo.getText().toString());
                startActivity(i);
            }
        });
        ...
        selectedngo=(EditText)findViewById(R.id.ngoselected);
        selectedngo.setText(message);}
